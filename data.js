...
//  Semaine 19 — 4 au 10 mai 2026 — Louvroil P854
//  Postes extraits directement du planning Excel
// =============================================
...
// Tâches / Postes — couleurs du fichier Excel d'origine
const TASKS = {
  'Pole1':   { label: 'Pôle 1',  color: '#C0392B' },  // rouge
  'Pole2':   { label: 'Pôle 2',  color: '#27AE60' },  // vert
  'Pole3':   { label: 'Pôle 3',  color: '#2980B9' },  // bleu
  'Caisses': { label: 'Caisses', color: '#F39C12' },  // orange
  'TDM':     { label: 'TDM',     color: '#00BCD4' },  // cyan
  'Divers':  { label: 'Divers',  color: '#7D5A2E' },  // marron
};
...
// =============================================
//  STAFF — postes extraits du planning Excel
//  task = poste réel de la journée
// =============================================
const STAFF = [
  {
  ...
  },
  {
    ...
    shifts: [
      ...
      { j: 'Mar', deb: 9,  fin: 15, task: 'Divers' },
  ...
  },
  {
    ...
    shifts: [
      { j: 'Lun', deb: 10, fin: 20, task: 'TDM' },
      { j: 'Mar', deb: 0,  fin: 0,  task: null },
      { j: 'Mer', deb: 7,  fin: 15, task: 'TDM' },
      { j: 'Jeu', deb: 9,  fin: 15, task: 'TDM' },
      { j: 'Ven', deb: 0,  fin: 0,  task: null },
      { j: 'Sam', deb: 10, fin: 14, task: 'TDM' },
    ],
  },
  {
  ...
  },
  {
    ...
    shifts: [
      ...
      { j: 'Mar', deb: 9,  fin: 15, task: 'Caisses' },
  ...
  },
  {
    ...
    shifts: [
      ...
      { j: 'Jeu', deb: 9,  fin: 15, task: 'Caisses' },
  ...
  },
  {
    ...
    shifts: [
      { j: 'Lun', deb: 11, fin: 18, task: 'Divers' },
