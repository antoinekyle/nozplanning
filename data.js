...
let STAFF = [
  ...
  {
    prenom:'Yohan',   totalSemaine:null,  nom:'', role:'AEM',           contrat:35, pin:'1002',
    shifts:[
  ...
  {
    prenom:'Anthony', totalSemaine:null,  nom:'', role:'AM',            contrat:35, pin:'1003',
    shifts:[
  ...
  {
    prenom:'Virginie',totalSemaine:null,  nom:'', role:'EMP',           contrat:35, pin:'1004',
    shifts:[
  ...
  {
    prenom:'Yanis',   totalSemaine:null,  nom:'', role:'EMP',           contrat:35, pin:'1005',
    shifts:[
  ...
  {
    prenom:'Mylene',  totalSemaine:null,  nom:'', role:'EMP',           contrat:35, pin:'1006',
    shifts:[
  ...
  {
    prenom:'Zao',     totalSemaine:null,  nom:'', role:'Contrat Pro',   contrat:35, pin:'1007',
    shifts:[
      { j:'Lun', deb:13.75, fin:19.5,  task:'Caisses', pause_deb:null, pause_fin:null },
      { j:'Mar', deb:10.75, fin:19.5,  task:'Caisses', pause_deb:13,   pause_fin:14   },
      ...
      { j:'Sam', deb:10.5,  fin:19.5,  task:'TDM',     pause_deb:13,   pause_fin:14   },
    ],
  },
  {
  ...
  {
    prenom:'Antoine', totalSemaine:null,  nom:'', role:'AEM',           contrat:39, pin:'1009',
    shifts:[
      { j:'Lun', deb:10,    fin:17.25, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mar', deb:9.5,   fin:19.75, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mer', deb:7,     fin:19.5,  task:'TDM',     pause_deb:13,   pause_fin:14   },
  ...
  {
    prenom:'Mady',    totalSemaine:null,  nom:'', role:'Expert métier', contrat:39, pin:'1010',
    shifts:[
      { j:'Lun', deb:10,    fin:17.25, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mar', deb:9.5,   fin:19.75, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mer', deb:7,     fin:19.5,  task:'TDM',     pause_deb:13,   pause_fin:14   },
  ...
  {
    prenom:'Willy',   totalSemaine:null,  nom:'', role:'AEMI',          contrat:39, pin:'1011',
    shifts:[
      { j:'Lun', deb:10,    fin:17.25, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mar', deb:9.5,   fin:19.75, task:'Divers',  pause_deb:14,   pause_fin:15   },
      { j:'Mer', deb:7,     fin:19.5,  task:'TDM',     pause_deb:13,   pause_fin:14   },
  ...
  {
    prenom:'Vanessa', totalSemaine:null,  nom:'', role:'EMP',           contrat:39, pin:'1012',
    shifts:[
